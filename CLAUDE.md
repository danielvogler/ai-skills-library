...
See **[AGENTS.md](AGENTS.md)** for the full workflow: conventional commits, changelog maintenance, skills add/update/remove steps, profile maintenance, and the quality bar every skill must meet. Follow it on every change.
